...
class Person {
	...
	public void eat(String foodToEat) throws InterruptedException {
		System.out.println("\nI'm hungry, I think I'm going to eat some " + foodToEat + " now.");
		Thread.sleep(500);
	...
	public static void main(String[] args) throws InterruptedException {
		...
		while (anotherAction.equals("yes")) {
			...
			System.out.println("\nYour person can do the following things:"
					...
					+ "\n7. Print information about themself");
			
			// Have them choose something:
			int choice = intTryRange("\nType the number of the thing you would like them to do: ", 1, 7);
			...
			if (choice == 1) {
				...
				System.out.println("\nWhat food would you like your person to eat? ");
				String food = userinput.nextLine();
				person1.eat(food);
			}
			else if (choice == 5) {
				System.out.println("\nYour person's full name is " + person1.getFullName()); 
			}
			else if (choice == 6) {
				System.out.println("\nWhat would you like to change your person's religion to? ");
			...
			anotherAction = yesOrNo("\nWould you like to perform another task? Enter \"yes\" or \"no\": ");
		}
